...
function random_particle(){
    return new Particle(rdm(1699,1), rdm(1199, 1), random_type())
}
let grid = new Grid(1700, 1200, 80)
let particles = new Array(500).fill('').map(x => random_particle())
